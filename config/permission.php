...
return [
    ...
    'admin' => [
        ...
        'wali_kelas' => ['wali_kelas index', 'wali_kelas view', 'wali_kelas store', 'wali_kelas update', 'wali_kelas destroy'],
        'pengajaran' => ['pengajaran index', 'pengajaran view', 'pengajaran store', 'pengajaran update', 'pengajaran destroy'],
        'jadwal' => ['jadwal index', 'jadwal view', 'jadwal store', 'jadwal update', 'jadwal destroy', 'teaching.schedule.view', 'class.schedule.view'],
        'kalender_akademik' => ['kalender_akademik index', 'kalender_akademik view', 'kalender_akademik store', 'kalender_akademik update', 'kalender_akademik destroy'],
        'attendance' => ['attendance.index', 'attendance.create', 'attendance.update', 'attendance index', 'attendance create', 'attendance update', 'attendance.manage'],
        'assessment' => [
    ...
    'guru' => [
        'jadwal' => ['jadwal index', 'jadwal view', 'teaching.schedule.view', 'class.schedule.view'],
        'pengajaran' => ['pengajaran index', 'pengajaran view'],
        ...
        'kalender_akademik' => ['kalender_akademik index', 'kalender_akademik view'],
