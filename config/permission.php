...
return [
    ...
    'admin' => [
        ...
        'jadwal' => ['jadwal index', 'jadwal view', 'jadwal store', 'jadwal update', 'jadwal destroy'],
        ...
        'attendance' => ['attendance.index', 'attendance.create', 'attendance.update', 'attendance index', 'attendance create', 'attendance update'],
        'assessment' => [
