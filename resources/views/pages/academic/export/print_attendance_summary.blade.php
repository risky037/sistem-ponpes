        ...
        <tbody>
            @forelse ($result['data'] as $row)
                <tr>
                    ...
                    <td class="text-center">{{ $row->present_count ?? 0 }}</td>
                    <td class="text-center">{{ $row->excused_count ?? 0 }}</td>
                    <td class="text-center">{{ $row->sick_count ?? 0 }}</td>
                    <td class="text-center">{{ $row->absent_count ?? 0 }}</td>
                    <td class="text-center"><strong>{{ number_format((float) ($row->attendance_rate ?? 0), 2) }}%</strong></td>
                </tr>
            @empty
                <tr>
                    <td colspan="10" class="text-center">Tidak ada data presensi yang sesuai dengan filter.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
